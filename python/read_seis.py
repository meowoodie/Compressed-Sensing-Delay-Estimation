...
with open(file_path, 'rb') as file:
    ...
    header = (header_struct.nt, header_struct.id, header_struct.rline, header_struct.rpt, header_struct.name, \
              header_struct.x, header_struct.y, header_struct.z, header_struct.t0, header_struct.dt)
