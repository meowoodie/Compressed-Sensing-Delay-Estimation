...
x1_data  = '5R572-0000/20140325.avg.txt';
x2_data  = '6B359-0000/20140325.avg.txt';
[x1, x2] = signal_reader(path, path, x1_data, x2_data, res_name);
...
times    = 50;           % The times of computation for one downsampling rate
